...
int main(int argc, const char *argv[]){
    ...
    std::cout << "1" << std::setw(17) << hours1 << std::setw(15) << charges1 << std::endl;
    std::cout << "2" << std::setw(17) << hours2 << std::setw(15) << charges2 << std::endl;
    std::cout << "3" << std::setw(17) << hours3 << std::setw(15) << charges3 << std::endl;
    std::cout << "TOTAL" << std::setw(13) << hours1 + hours2 + hours3 << std::setw(15)
              << charges1 + charges2 + charges3 << std::endl;
