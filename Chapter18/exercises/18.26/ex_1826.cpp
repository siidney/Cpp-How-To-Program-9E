...
void selectionSort(std::string[], const size_t, bool (*)(std::string&, std::string&));
...
int main(int argc, const char* argv[]){
    ...
    std::string a[arraySize] = {"test", "avacado", "ascending", "zebra", "cellphone",
...
void selectionSort(std::string a[], const size_t size, bool (*compare)(std::string&, std::string&)){
...
bool ascending(std::string& a, std::string& b){
    return a < b;
}
// descending order sort
bool descending(std::string& a, std::string& b){
    return a > b;
}
