...
std::string getNewWord(std::vector<std::string>& wordList){
...
// print the hangman
// TODO: find a more efficient way of doing this (remove the repetition)
...
// print guessList
void printGuesses(std::vector<char>& guessList){
