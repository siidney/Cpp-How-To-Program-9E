...
void HeartRates::getTargetHeartRate(){
    ...
    std::cout << 0.5 * getMaximumHeartRate() << " - " <<  0.85 * getMaximumHeartRate() << std::endl;
}
// displays person information
void HeartRates::displayInformation(){
    std::cout << "\nName: " << getFirstName() << " " << getLastName() << std::endl;
    std::cout << "D.O.B: " << getMonth() << "/" << getDay() << "/" << getYear() << std::endl;
