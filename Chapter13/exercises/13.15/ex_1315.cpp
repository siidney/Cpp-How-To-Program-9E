...
int main(int argc, const char *argv[]){
    ...
    TwoDayPackage tdp1(
            ...
            12.0f, 5.0f, 1.0f);
    TwoDayPackage tdp2(
            Person("Sue", "Sender", "From Street", "From City", "From State", "53N-D3R"),
            Person("Roger", "Reciever", "To Street", "To City", "To State", "R3C-3NT"),
            24.5f, 2.5f, 1.0f);

    // overnight packages
    OvernightPackage op1(
            Person("Bob", "Bobson", "12 Bob Street", "BobVille", "Bobzone", "B0B-50N"),
            Person("Sue", "Sueson", "12 Sue Street", "SueVille", "Suezona", "5U3-50N"),
            12.0f, 5.0f, 1.0f);
    OvernightPackage op2(
            Person("Bob", "Bobson", "12 Bob Street", "BobVille", "Bobzone", "B0B-50N"),
            Person("Sue", "Sueson", "12 Sue Street", "SueVille", "Suezona", "5U3-50N"),
            15.0f, 5.6f, 1.0f);
    ...
    for(size_t i=0; i<packages.size(); ++i){
        std::cout << packages[i]->getPackageType()
                  ...
                  << "\nPACKAGE COST: $" << packages[i]->calculateCost()
                  << "\n\n";
